...
summary: next-mdx-remote를 사용하여 MDX파일을 불러와 목록과 내용을 추출하고, gray-matter를 사용해 파일의 속성을 가져옵니다.
tag: Next
---
...
![파일 디렉토리](posts/next-mdx/directory.webp)
...
![MDXRemote를 통해 가져온 MDX 파일](posts/next-mdx/first-mdx.webp)
...
![MDX 파일 목록](posts/next-mdx/mdx-list.webp)
...
![](posts/next-mdx/title-link.webp)
...
![스타일링 된 코드블럭](posts/next-mdx/code-last.webp)
...
![스타일링 된 코드블럭](posts/next-mdx/code-first.webp)
...
![](posts/next-mdx/mdx-list-tag.webp)
