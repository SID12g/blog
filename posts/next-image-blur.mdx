...
summary: Next.js에서 이미지 블러를 적용하여 UI/UX를 개선하는 방법을 알아봅니다.
tag: Next
---
...
![정적 이미지](posts/next-image-blur/static.gif)
...
![동적 이미지](posts/next-image-blur/dynamic.gif)
...
![인터넷 사용기록 삭제](posts/next-image-blur/chrome.webp)
