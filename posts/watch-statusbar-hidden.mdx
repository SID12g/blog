...
summary: Apple Watch에서 상태바를 숨기는 법을 알아봅니다.
tag: Swift
---
...
![Apple Watch 시간이 보이는 상태바](posts/watch-statusbar-hidden/visible.webp)
...
![Apple Watch 상단에서 사라진 상태바](posts/watch-statusbar-hidden/invisible.webp)
