...
![](posts/nestjs-docs/1.webp)

프로젝트를 실행한다면 터미널에서 위와 같은 결과를 확인할 수 있다.

## 컨트롤러

![](posts/nestjs-docs/2.webp)
