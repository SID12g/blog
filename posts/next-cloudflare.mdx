...
summary: Cloudflare Pages로 Next.js 프로젝트를 배포하는 방법을 알아봅니다.
tag: Next
---
...
![Cloudflare Workers 및 Pages 탭](posts/next-cloudflare/pages.webp)

그리고 상단의 생성 버튼을 눌러줍니다.

![Cloudflare 프로젝트 생성](posts/next-cloudflare/select.webp)

그리고 Pages를 선택한 뒤에 기존 Git 레포지토리 가져오기를 선택합니다.

![Git 프로젝트 가져오기](posts/next-cloudflare/git.webp)

그리고 가져올 GitHub 레포지토리를 선택합니다.

![Build 설정](posts/next-cloudflare/build.webp)

그리고 프레임워크와 빌드 명령어를 맞게 설정해줍니다.

![배포 완료](posts/next-cloudflare/complete.webp)
