...
summary: 전 알고리즘과 인공 신경망이 어떤 구조를 가지고 있는지 알아보고, 게임 죽림고수를 플레이 하면서 이해합니다.
tag: Algorithm
---

> 이전 포스트인 [죽림고수 만들기](/bamboo-master)와 연결됩니다!
...
![유전 알고리즘 구조도](posts/genetic-network/genetic-algorithm-struct-chart.webp)
...
![인공신경망 구조](posts/genetic-network/neural-network.webp)
...
![죽림고수에 적용할 인공 신경망 구조](posts/genetic-network/bamboo-master-neural-network.webp)
...
![실험 중 건드리지 않는 착한 디미고 친구들](posts/genetic-network/dimigo1.webp)
![바로 변질됨](posts/genetic-network/dimigo2.webp)
...
[발표자료 다운로드](posts/genetic-network/죽림고수에%20유전%20알고리즘%20및%20인공%20신경망%20적용하기.pdf)
