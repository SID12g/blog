...
summary: 대표적인 렌더링 방식 CSR, SSR, SSG를 알아보고, SSG로 블로그 속도를 개선한 과정을 소개합니다.
tag: Next
---
...
![이전 블로그 (v2)와 현재 블로그 (v3) 속도 비교](posts/about-rendering/v2_v3.gif)
...
![SSG 적용 전과 적용 후](posts/about-rendering/v3_v3.gif)
